...
def crawl_class(out_dir: str, cls: int, keywords: List[str], per_class: int, per_keyword_limit: int):
...
def main():
    ...
    crawl_class(args.out_dir, 0, kw0, args.per_class, args.per_keyword_limit)
    crawl_class(args.out_dir, 1, kw1, args.per_class, args.per_keyword_limit)
    crawl_class(args.out_dir, 2, kw2, args.per_class, args.per_keyword_limit)
